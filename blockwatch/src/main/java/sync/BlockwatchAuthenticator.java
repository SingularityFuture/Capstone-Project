...
/**
 * Manages "Authentication" to Blockwatch's backend service.  The SyncAdapter framework
 ...
 */
public class BlockwatchAuthenticator extends AbstractAccountAuthenticator {

    public BlockwatchAuthenticator(Context context) {
        super(context);
    }
